...
FeedItem.prototype.createFeedItem = async function(feedItem) {
    ...
    console.log('url in post feedItem = ' + url + ' and name = ' + fileName, 'and description' + description);
    try {
        const sqlText = "INSERT INTO feeditem(title, media, description) VALUES($1, $2, $3)";
